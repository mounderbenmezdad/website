...
<div class="dashboard-nav">
        ...
        <nav class="navigationbar">
            ...
            <div class='dashboard-nav-dropdown'><a href="#!" class="dashboard-nav-item dashboard-nav-dropdown-toggle"><i
                    class="fas fa-photo-video"></i> Our </a>
                <div class='dashboard-nav-dropdown-menu'><a href="#doctors" class="dashboard-nav-dropdown-item">Medecins</a><a
                        href="#nurses" class="dashboard-nav-dropdown-item">Infirmiers</a><a
                        href="#patients" class="dashboard-nav-dropdown-item">Patients</a>
                       <a href="#doctors" class="dashboard-nav-dropdown-item">Medecins</a></div>
            </div>
